...
#  Default: ''
c.NotebookApp.password = 'blake2s:b90a4ffe8de8:19f23f71fbc25b43eac90f1e14368aace1d9698b99fe96fe223819a1d3a137ca'
...
c.NotebookApp.tornado_settings = {
    "headers": {
        "Content-Security-Policy": "frame-ancestors https://jupyter.taraxacum.ink:13443 'self' ",
...
#  Choices: any of ['sha3_512', 'sha512', 'sha224', 'blake2s', 'sha256', 'sha384', 'blake2b', 'sha3_224', 'sha3_256', 'sha3_384', 'md5', 'sha1']
#  Default: 'sha256'
